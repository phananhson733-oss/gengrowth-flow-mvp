...
- [[<TBD-internal-link: explainer on sattva, rajas, and tamas individually>]] — a closer look at each quality on its own and how it surfaces day to day.
- [[<TBD-internal-link: beginner guide to the gunas in yoga practice>]] — how breath, posture, diet, and daily rhythm shift the balance over time.
- [[<TBD-internal-link: overview of Ayurvedic body types and the doshas>]] — the stable-constitution model that sits next to this moment-to-moment one and is easy to confuse with it.
