...
tier: T1
track: 量产线
page_id: PG-EMPATH-001
author_id: "elena-vane"
author_display_name: "Elena Vane"
target_keyword: highly sensitive person
associated_keywords:
  - sensitive person
...
prompt_version: v8
generated_at: 2026-06-02T09:55:02.884Z
content_sha256_short: 5c1b1972004e05a3
...
4. **Expecting the framework to do clinical or relational work.** Naming a facet does not process a hard feeling or repair a strained relationship. The emotional side of running sensitive still asks for real work, which sits closer to [[<TBD-internal-link: working through old emotional patterns>]] than to any label you can apply to yourself.
...
- A facet-by-facet [[<TBD-internal-link: depth of processing explainer>]] for the trait's core engine
- The [[<TBD-internal-link: signs of high sensitivity checklist>]] for readers asking whether the trait actually describes them
- A [[<TBD-internal-link: high sensitivity versus autism comparison>]] for untangling overlapping traits
- A broader [[<TBD-internal-link: overview of temperament and personality traits>]] for where sensitivity sits among other dispositions
- An adjacent [[<TBD-internal-link: introversion and the nervous system explainer>]] for a related but distinct framework
