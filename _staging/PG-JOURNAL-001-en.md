...
target_keyword: journal prompts
associated_keywords:
...
prompt_version: v8
generated_at: 2026-06-05T21:39:07.892Z
content_sha256_short: 0a685d8d9f34bb8f
...
The broader landscape of structured self-inquiry tools — where journal prompts sit alongside practices like guided visualization and astrological self-reflection — is covered in [[<TBD-internal-link: pillar page on self-reflection tools and journaling practices>]].
...
- [[<TBD-internal-link: guide to shadow work journaling and what it surfaces>]] — covers how shadow work prompts specifically target avoided material, extending the diagnostic approach into unconscious patterns
- [[<TBD-internal-link: overview of self-reflection tools and journaling approaches>]] — the broader landscape of structured introspection methods that prompt-based journaling belongs to
- [[<TBD-internal-link: comparison of journaling styles and psychological uses>]] — useful for understanding where diagnostic prompting fits relative to free writing, stream-of-consciousness, and gratitude journaling
