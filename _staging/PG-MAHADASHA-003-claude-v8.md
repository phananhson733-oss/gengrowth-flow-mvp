...
- [[<TBD-external-link: Wikipedia | Dasha (astrology) | overview of the Vimshottari dasha system the Rahu period belongs to>]] — for the broader timing framework behind the 18-year period.
- [[<TBD-external-link: Wikipedia | Lunar node | the astronomical basis of Rahu as the Moon's north node>]] — for what the north node actually is in observational terms.
