...
A Saturn mahadasha differs from the better-known Saturn return of Western astrology, and telling them apart is where the [[<TBD-internal-link: comparison of Vedic and Western astrology systems>]] earns its keep. Read against its neighbors, the period works like this:
...
- [[<TBD-external-link: Wikipedia | Dasha (astrology) | overview of the Vimshottari dasha system this period belongs to>]] — background on how the planetary periods are calculated and sequenced.
- [[<TBD-external-link: NASA | Saturn | the astronomical planet behind the graha Shani>]] — the physical body the tradition names as Shani.
