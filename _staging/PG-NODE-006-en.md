...
target_keyword: north node in gemini
associated_keywords:
  - gemini north node
  - north node gemini
...
prompt_version: v8
generated_at: 2026-06-04T19:49:51.599Z
content_sha256_short: 0cf8ed6f17784a7d
...
- [[<TBD-internal-link: Gemini sign overview>]] — the sign your north node is slowly learning to live out day to day.
- [[<TBD-internal-link: Sagittarius sign overview>]] — the south-node energy you already carry and are learning to hold more lightly.
- [[<TBD-internal-link: guide to reading the nodal axis in a birth chart>]] — how to locate both nodes and read them as a single story.
- [[<TBD-external-link: Wikipedia | Lunar node | the astronomy behind the north and south nodes a chart uses>]] — background on what the nodes physically are.
