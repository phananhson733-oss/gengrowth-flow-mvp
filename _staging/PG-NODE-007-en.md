...
target_keyword: north node in sagittarius
associated_keywords:
  - north node sagittarius
  - south node in gemini
generated_by: unknown
prompt_version: v8
generated_at: 2026-06-04T21:22:54.401Z
content_sha256_short: 060d1d0b3c8edf84
...
- [[<TBD-internal-link: Gemini sign overview page>]] — the south-node energy you are growing out of, and why it feels so natural to fall back on.
- [[<TBD-internal-link: explainer on the south node in Gemini>]] — a closer look at the past-pattern half of this nodal axis.
- [[<TBD-external-link: Wikipedia | Lunar node | the astronomy behind the north and south nodes of the Moon>]] — background on what the nodes physically are.
