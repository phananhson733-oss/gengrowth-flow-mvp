...
## the Blue-Node Convention vs the Actual North Node: How It Works + Trade-offs
...
5. Read the node by its sign and house, as covered in the [[<TBD-internal-link: guide to finding the North Node sign and house>]], and set the color aside for good.
...
- [[<TBD-internal-link: comparison of the North Node across all twelve signs>]] — read the placement the blue symbol actually marks, sign by sign
- [[<TBD-internal-link: explainer on Rahu and Ketu in Vedic astrology>]] — see how the same axis is named and read in another tradition
