...
target_keyword: striking distance keywords
associated_keywords:
  - striking distance keywords seo
  - striking distance report
  - position 11-20 keywords
  - quick win keywords search console
generated_by: unknown
prompt_version: v8
generated_at: 2026-08-07T12:12:06.251Z
content_sha256_short: 6cbb4df75d4db3e3
...
This is the diagnostic half of keyword work; the selection half is covered in the [[<TBD-internal-link: pillar guide to low hanging fruit keywords and keyword difficulty>]], which is about picking terms worth ranking for in the first place.
...
For a structured starting point before prioritizing, [[<TBD-internal-link: how to segment a traffic drop before diagnosing it>]] walks through how to segment GSC data as a first diagnostic step before drawing any conclusions about which pages to fix.
...
One of those fix types deserves its own workflow: when the lever is internal links rather than copy, the [[<TBD-internal-link: guide to internal link structure and link equity>]] covers how to find the pages that are already wasting the authority you have.
...
- [[<TBD-internal-link: guide to pagerank sculpting and link equity>]] — for whether pointing more internal links at a striking-distance page is still a lever that works
- [[<TBD-internal-link: series walkthrough of zero search volume keywords>]] — for the opposite problem: a term the tools report as having no demand at all
- [[<TBD-internal-link: pillar guide to low hanging fruit keywords and keyword difficulty>]] — for choosing which terms are worth this workflow in the first place
...
- [[<TBD-external-link: Google Search Console Help | What are impressions, position, and clicks? | the official definition of average position, which Google describes as averaging the topmost position value across all impressions>]]
