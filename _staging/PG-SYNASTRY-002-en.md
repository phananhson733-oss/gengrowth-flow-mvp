---
title: Synastry Chart Compatibility
...
tier: T2
track: 量产线
page_id: PG-SYNASTRY-002
author_id: "marcus-orion"
author_display_name: "Marcus Orion"
target_keyword: synastry chart compatibility
associated_keywords:
...
prompt_version: v8
generated_at: 2026-06-08T09:02:30.669Z
content_sha256_short: 80f475c233d61472
...
A closely related territory is the [[<TBD-internal-link: guide to Saturn return and relational timing>]], which addresses how the same Saturn themes that appear in synastry also show up in individual natal timing — the connection helps clarify why Saturn contacts read as productive pressure rather than red flags.
...
- [[<TBD-internal-link: guide to natal chart houses and their life areas>]] — house overlays in synastry become clearer once you understand what each house governs in a single chart
- [[<TBD-internal-link: overview of lunar nodes and karmic path indicators>]] — some synastry readings weight nodal contacts as long-arc relational indicators alongside aspect contacts
- [[<TBD-external-link: Wikipedia | Astrological compatibility | overview of how astrological compatibility analysis is categorized>]]
