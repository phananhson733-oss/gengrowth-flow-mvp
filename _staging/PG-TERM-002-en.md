...
prompt_version: v8
generated_at: 2026-05-29T05:50:47.034Z
content_sha256_short: 497452fea40f9883
...
1. **Sextile vs trine.** A trine is a 120-degree angle where two planets cooperate with no effort at all, while a sextile asks for a small push first. To get the effortless flow of the [[<TBD-internal-link: explainer on the trine aspect>]], you sacrifice the urgency to develop it, so the talent can sit unused; to get the sextile's growth, you sacrifice the comfort and have to make the first move.
...
- [[<TBD-internal-link: overview of the major chart aspects>]] — for the full set of angles beyond the sextile covered here
- [[<TBD-external-link: Wikipedia | Astrological aspect | the astronomical basis for the angles between planets, including the sextile>]] — for the technical background on how aspects are measured
