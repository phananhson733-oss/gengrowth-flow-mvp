...
prompt_version: v8
generated_at: 2026-05-29T05:16:57.471Z
...
3. **Square vs sextile.** A sextile, like the [[<TBD-internal-link: explainer on the sextile aspect>]], offers a gentle opportunity that only activates if you reach for it. To get that low-cost option, you sacrifice the urgency a square supplies for free. The sextile waits politely; the square does not.
...
- [[<TBD-external-link: Wikipedia | Astrological aspect | overview of how the major aspects, including the square, are measured on the chart wheel>]] — for the angular definitions behind every aspect, including the opposition this page contrasts with the square
