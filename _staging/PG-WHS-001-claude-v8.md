...
3. **Margin.** Every warning you chase is billable time, so sorting signal from noise early is what keeps an audit profitable — a tension we unpack in [[<TBD-internal-link: workflow guide to running a site audit>]].
...
- [[<TBD-internal-link: comparison of popular site audit tools>]] — for choosing which vendor produces the score you'll standardize on
- [[<TBD-internal-link: guide to site audit tool pricing>]] — for budgeting monitoring across a full client roster
- [[<TBD-internal-link: explainer on crawl budget for large sites>]] — for why the same rating misreads a large store versus a small brochure site
