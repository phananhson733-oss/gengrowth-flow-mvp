...
solar return ascendant, natal chart overlay, sun's house placement, ascendant ruling planet, critical degree positions（太阳回归五项重点）是用生日回归时刻看一年主题的读盘组合。它连接 [[<TBD-internal-link: 占星行运工具总览 pillar 页>]]，焦点更窄：看这一年哪些本命主题被推到台前。太阳回归盘通常是**年度主题星盘**。
...
- [[<TBD-internal-link: 次限推运入门指南>]]：适合把年度主题放进更长时间线里比较。
- [[<TBD-internal-link: 太阳弧推运对照表>]]：适合查看同一年是否有清晰的本命点移动线索。
