...
// 2026-05-27 word-count fix: the prompt AIM is set above the gate floor so the
// model's habitual undershoot still clears word_range_min. The fixture sidecar
