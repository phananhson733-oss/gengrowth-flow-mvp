...
//     gh api "repos/<owner>/<name>/deployments?ref=<branch>" --jq '.[0].id'
//     gh api "repos/<owner>/<name>/deployments/<id>/statuses" --jq '.[0] | {state,environment_url}'
...
//   --repo <owner/repo>   default: lib/site-profile.mjs publishRepo() (GG_PUBLISH_REPO overrides)
