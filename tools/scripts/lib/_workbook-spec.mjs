...
export const TABS = [
...

  {
    name: 'CTA Map',
    type: 'standard',
    header: ['cta_id', 'page_role', 'cta_文案', 'target_url', 'ga4_event_name', 'track', 'desc', 'cta_kind', 'match_keywords', 'blog_eligible', 'priority'],
    headerColorByCol: { 1: 'green', 2: 'slate', 3: 'green', 4: 'green', 5: 'slate', 6: 'slate', 7: 'green', 8: 'green', 9: 'green', 10: 'green', 11: 'green' },
    seedRows: [
    ...
    extras: {
      ...
      headerBold: true,
      headerFontSize: 11,
      columnWidths: [160, 100, 220, 240, 150, 90, 300, 120, 260, 110, 90],
      dataValidations: [
