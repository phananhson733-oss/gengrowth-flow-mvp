...
function planPromptFor(repo, slug) {
  ...
  return [
    ...
    `  "articles": { "${slug}": {`,
    `     "hero": { "prompt": "<atmospheric scene prompt>", "altEn": "<=140 chars", "altZh": "<natural Chinese>" },`,
    `     "inline": [ /* 0 to 3 of these, ONLY where a data-bearing section warrants it */`,
    `       { "kind": "sequence|compare|timeline",`,
    `         "afterHeadingEn": "## <verbatim EN H2 heading>", "afterHeadingZh": "## <verbatim ZH H2 heading, only if a Zh export exists>",`,
    `         "titleEn": "...", "titleZh": "...",`,
    `         /* sequence: "items":[{"nameEn","nameZh","subEn","subZh"}] (3-7) */`,
    `         /* compare:  "columns":[{"nameEn","nameZh","linesEn":[],"linesZh":[]}] (2-3) */`,
    `         /* timeline: "items":[{"labelEn","labelZh","titleEn","titleZh","noteEn","noteZh"}] (3-6) */`,
    `         "altEn": "...", "altZh": "..." } ]`,
    `  } }`,
    `}`,
    ``,
